...
var translations = [
  ...
  { s: '.feature-card:nth-child(5) p', en: 'Mood-specific breathing exercises. Feeling overwhelmed? Different reset than feeling anxious. Personalized to what you actually need right now.', es: 'Ejercicios de respiración según tu ánimo. ¿Abrumada? Reset diferente a cuando estás ansiosa. Personalizado a lo que realmente necesitas.' },
  { s: '.feature-card:nth-child(6) h3', en: 'Ask for Help', es: 'Pide Ayuda' },
  { s: '.feature-card:nth-child(6) p', en: 'Can\'t find the words? We wrote them. Pre-written messages to your partner or mom friend. Customize or send as-is. One tap to text.', es: '¿No encuentras las palabras? Ya las escribimos. Mensajes pre-escritos para tu pareja o amiga. Personaliza o envía tal cual. Un toque.' },
  { s: '.feature-card:nth-child(7) h3', en: 'Mood Tracking', es: 'Seguimiento de Ánimo' },
  { s: '.feature-card:nth-child(7) p', en: 'Spot your patterns. Daily check-ins, weekly mood maps, wins jar, and streaks. Zero effort logging with daily ADHD micro-lessons.', es: 'Descubre tus patrones. Check-ins diarios, mapas de ánimo semanales, frasco de victorias y rachas. Registro sin esfuerzo con micro-lecciones diarias.' },
  { s: '.feature-card:nth-child(8) h3', en: 'Focus Timer', es: 'Temporizador de Enfoque' },
  { s: '.feature-card:nth-child(8) p', en: 'ADHD-friendly timer that breaks tasks into tiny, doable chunks. With celebration when you finish.', es: 'Temporizador amigable con el TDAH que divide tareas en pedacitos posibles. Con celebración cuando terminas.' },
  { s: '.feature-card:nth-child(9) h3', en: 'Bilingual: EN + ES', es: 'Bilingüe: EN + ES' },
  { s: '.feature-card:nth-child(9) p', en: 'Full Spanish support for Latina ADHD moms. Switch between English and Spanish anytime. Because every mama deserves support in her language.', es: 'Soporte completo en español para mamás latinas con TDAH. Cambia entre inglés y español cuando quieras. Porque toda mamá merece apoyo en su idioma.' },
  // Mental Weight
